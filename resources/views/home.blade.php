    ...
    <div x-data="{ sidebarOpen: false }" class="min-h-screen relative overflow-x-hidden">
        ...
        <div x-show="sidebarOpen" 
            ...
            <nav class="flex flex-col gap-3 overflow-y-auto pr-2 custom-scrollbar flex-1">
                ...
                <a href="/apply-staff" class="px-6 py-5 text-slate-700 bg-purple-50/50 hover:bg-purple-600 hover:text-white rounded-2xl transition-all font-black text-lg border-2 border-transparent hover:border-purple-400">Apply</a>
                <a href="/report" class="px-6 py-5 text-slate-700 bg-purple-50/50 hover:bg-purple-600 hover:text-white rounded-2xl transition-all font-black text-lg border-2 border-transparent hover:border-purple-400">Submit Report</a>
